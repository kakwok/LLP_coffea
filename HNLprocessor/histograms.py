...
histograms ={
            ...
            "muPt_sys": hist.Hist("Events",dataset_axis,
                hist.Cat("Sys","Sys"),
                hist.Cat("region", "region"), 
                hist.Bin("muPt", "muPt", 40, 0, 100),
            ),
            "elePt_sys": hist.Hist("Events",dataset_axis,
                hist.Cat("Sys","Sys"),
                hist.Cat("region", "region"),
                hist.Bin("elePt", "elePt", 40, 0, 100),
            ),
            ...
            ## gen var.
            "gLepPhi": hist.Hist("Events",dataset_axis,
                hist.Bin("gLepPhi", "gLepPhi", 30, 0,np.pi),
            ),                    
            "gLepPt": hist.Hist("Events",dataset_axis,                
                hist.Bin("gLepPt", 'gLepPt', 50, 0,500),
            ), 
            "gLepEta": hist.Hist("Events",dataset_axis,
                hist.Bin("gLepEta", 'gLepEta', 40, -5, 5),
            ),
